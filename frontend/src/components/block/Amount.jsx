export default function Amount() {
  return (
    <div className="w-[384px] bg-gray-100 rounded-lg">
      <div className="flex px-[24px] py-[16px] items-center gap-[10px]">
        <svg
      ...
      <div className="px-[24px] py-[20px] border-[1px] border-t-gray-400 ">
        <div className="flex items-center gap-[5px]">
          <div className=" font-[Roboto] text-[36px]">1,200,000</div>
          <div className="font-[Roboto] text-[30px]">₮</div>
        </div>
        <div className="font-[Roboto] text-[#64748B] text-[18px] 	">
          Your Income Amount
        </div>
