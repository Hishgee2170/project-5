export default function Card() {
  return (
    <div className="relative w-[384px]">
      <img
        src="https://golomtbank.com/wp-content/uploads/2020/04/Credidcard_Gan-470x296.png"
        alt=""
      ></img>
      <div className="absolute  top-[100px] left-[270px] ">
        <svg
      ...
      <div className="absolute text-[15px] text-gray-400 top-[120px] left-[60px]">
        Cash{" "}
      </div>
      <div className="absolute text-[20px] text-gray-300 top-[140px] left-[60px]">
        10,000.00
      </div>
    </div>
  );
